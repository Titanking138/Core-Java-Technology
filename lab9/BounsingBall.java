...
import java.awt.*;
/*
<applet code="BounsingBall" width="300" height="200">
</applet>
*/
class circle extends Thread
{
  ...
  public int inc;
  public int dir;
  public BounsingBall s1;
  public void draw(Graphics g)
  {
    g.fillOval(x,y,r,r);
  }
  public circle(int xx,int yy,int rr,int d,int l,BounsingBall s)
  {
    x=xx;y=yy;r=rr;
    dir=d;
    s1=s;
...
public class BounsingBall extends Applet
{
